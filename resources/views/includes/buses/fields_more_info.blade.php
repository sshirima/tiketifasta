<div class="form-group">
    ...
    <div class="col-sm-7">
        {{Form::text('driver_name',$bus[\App\Models\Bus::COLUMN_DRIVER_NAME],['class'=>'form-control'])}}
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-7">
        {{Form::text('conductor_name',$bus[\App\Models\Bus::COLUMN_CONDUCTOR_NAME],['class'=>'form-control'])}}
    </div>
</div>
<div class="form-group">
    {!! Form::label('condition', __('merchant_page_buses.form_field_label_bus_condition'), ['class'=>'col-sm-5 control-label', 'for'=>'condition']) !!}
    <div class="col-sm-7">
        {{Form::select('condition',$conditions,$bus[\App\Models\Bus::COLUMN_BUS_CONDITION],['class'=>'form-control'])}}
    </div>
</div>