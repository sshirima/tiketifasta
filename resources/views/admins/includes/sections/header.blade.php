<header class="main-header">
    ...
    <a href="{{route('user.home')}}" class="logo">
        ...
        <span class="logo-lg"><b>tiketiFASTA</b></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            ...
                            <p>
                                {{$admin[\App\Models\Admin::COLUMN_FIRST_NAME].' '.$admin[\App\Models\Admin::COLUMN_LAST_NAME]}}
                                <small>Created at {{date_format(date_create($admin->created_at), "M, Y")}}</small>
                            </p>
                        </li>
                        <!-- Menu Body -->
                        {{--<li class="user-body">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{route('admin.profile.show')}}" class="btn btn-default btn-flat">{{__('merchant_header.profile')}}</a>
                            </div>
