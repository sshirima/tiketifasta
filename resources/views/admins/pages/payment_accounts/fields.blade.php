...
<div class="form-group">
    <div class="col-sm-7 col-md-offset-5">
        {!! Form::submit(__('admin_pages.page_payment_account_fields_button_save'), ['class' => 'btn btn-primary']) !!}
        <a href="{!! route('admin.payments-accounts.index') !!}" class="btn btn-default">{{__('admin_pages.page_locations_fields_button_cancel')}}</a>
    </div>
</div>
