...
@section('title')
    {{ __('admin_pages.page_ticket_prices_create_title') }}
@endsection
...
@section('panel_body')
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5>{{__('admin_pages.page_ticket_prices_create_form_title')}}</h5>
        </div>
        <div class="panel-body">
            @include('includes.errors.message')
            <div class="col-md-6">
                <form class="form-horizontal" role="form" method="post"
                      action="{{route('admin.ticket_prices.store')}}" accept-charset="UTF-8" style="padding: 20px">
