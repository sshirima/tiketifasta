...
class C2BCollectionsByBuses extends \koolreport\KoolReport
{
    ...
    public function setup()
    {
        ...
        $query = DB::table('schedules')
            ->select('buses.reg_number as reg_number',
            ...
            ->groupBy('buses.reg_number')->toSql();

        $this->src('database')
            ->query($query)
            ->pipe(new Limit(array(10)))
            ->pipe($this->dataStore('buses_collections'));
    }
}